              ...
              <div className="container mx-auto px-5 xl:px-0 md:flex justify-center">
                  <div className="zipcode-wrap text-center md:text-left">
                    <div className="profile flex items-center justify-center md:justify-start mb-10 xl:mb-8">
                      ...
                      <p className="text-3xl xl:leading-none mb-10 mt-10 ml-2">What is your name and email?</p>
                    </div>
                      ...
                      <div className="form-wrap md:ml-0 md:text-center">
                          <form>
                            ...
                            <div className='flex flex-col items-center'>
                              <input className="border outline-none w-72 text-xl rounded-xl py-2 px-5 md:py-3 xl:px-7 xl:pt-5 xl:pb-4" type="text" name="name" placeholder="Your name" value={this.state.name} onChange={this.updateName}/>
                              <input className="border outline-none w-72 text-xl rounded-xl py-2 px-5 md:py-3 xl:px-7 xl:pt-5 xl:pb-4 mt-3" type="text" name="email" placeholder="Email Address" value={this.state.email} onChange={this.updateEmail}/>
                              <div className="btn-wrap mt-10">
                                  <a href={`/onboarding/${this.props.store.lead._id}/steps/3`} className="back-btn mr-5 xl:mr-3 border capitalize text-xl md:text-3xl transform hover:scale-110 motion-reduce:transform-none inline-block text-white rounded-full py-3 px-10 md:px-12">back</a>
