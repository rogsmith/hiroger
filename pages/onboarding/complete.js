            ...
            <section class="intro pt-40 xl:pt-52">
                <div class="container mx-auto px-5 md:flex justify-center">
                    <div class="intro-wrap text-center md:text-left">
                        ...
                        <p class="text-2xl xl:leading-none mb-10"> I will give you a call on: <Moment format="MM/DD">{this.state.date}</Moment> at <Moment format="hh:mm">{this.state.date}</Moment></p>
